...
{
    protected function assertRemainsTheSame(string $sourceFile, Settings|null $settings = null): void
    {
        if ($settings === null) {
            $settings = new Medas();
        }
    ...
    protected function assertChanges(string $sourceFile, string $targetFile, Settings|null $settings = null): void
    {
        if ($settings === null) {
            $settings = new Medas();
        }
